...
public class CreateAccountFormTest {
	...
	public void setup() {
		...
		account = new Account(driver);
		 baseUrl = testDataReader.getCellData("BaseURL", "Data1");
	...
	public void authenticationPage() {
		...
		BrowserActions.navigateToURL(driver,baseUrl,baseUrl);
	...
	public void createAccountSuccessfully() {
		...
		createAccountForm.setCustomerEmailField(testDataReader.getCellData("Registered Email", "Data1"));
		createAccountForm.getRegisterBtn().click();
